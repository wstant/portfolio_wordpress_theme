...
function hackeryou_styles(){
	...
	// wp_enqueue_style('flickity', 'https://npmcdn.com/flickity@2.0/dist/flickity.min.css');
...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
  	'flickity',
  	"http://npmcdn.com/flickity@2.0/dist/flickity.pkgd.min.js",
  	false, //dependencies
  	null, //version number
  	true //load in footer
  );
  wp_enqueue_script(
  	'maps',
  	"https://maps.googleapis.com/maps/api/js?key=AIzaSyDUVEcCgOg1rDdG8OfAwmDLBSaPtZiJgtY",
  	false, //dependencies
  	null, //version number
...
function my_acf_google_map_api( $api ){
	...
	$api['key'] = 'AIzaSyDUVEcCgOg1rDdG8OfAwmDLBSaPtZiJgtY';
